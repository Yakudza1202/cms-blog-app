    ...
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="grid grid-cols-1 gap-4 pb-4">
        <div>
          ...
          <label htmlFor='storeData' className='ml-2 text-gray-500 cursor-pointer'>Save my name, email in this browser for the next time I comment.</label>
        </div>
      </div>
      {error && <p className="text-cs text-red-500">All fields are required</p> }
      <div className='mt-8'>
        <button 
          onClick={handleCommentSubmission}
          type='button' 
          className="transtion duration-500 ease hover:bg-indigo-900 inline-block bg-indigo-400 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer"
        >Post Comment</button>
